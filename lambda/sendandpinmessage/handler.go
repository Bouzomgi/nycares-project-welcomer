...
func (h *SendAndPinMessageHandler) Handle(ctx context.Context, input models.SendAndPinMessageInput) (models.SendAndPinMessageOutput, error) {
	...
	err := h.usecase.Execute(ctx, auth, input.ExistingProjectNotification.Id, input.ExistingProjectNotification.ChannelId, input.MessageToSend.TemplateRef, input.MessageToSend.GeneratedContent, input.ExistingProjectNotification.Name)
	if err != nil {
